...
import { getConnection, findVol, addVol, delVol } from '@/server/actions/actions'
...
const Main = () => {
    ...
    function handleChange(e: React.FormEvent<HTMLInputElement>) {
        ...
        if (target.id === "name") {
            setInput({name: target.value, age: volInput.age, major: volInput.major, gpa: volInput.gpa})
        } else {
            setInput({name: volInput.name, age: target.value, major: volInput.major, gpa: volInput.gpa})
        }
    }
